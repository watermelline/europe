...
class ItinerariesControllerTest < ActionController::TestCase
  ...
  test "should create itinerary" do
    assert_difference('Itinerary.count') do
      post :create, itinerary: { date: @itinerary.date, details: @itinerary.details, location: @itinerary.location }
    end
  ...
  test "should update itinerary" do
    patch :update, id: @itinerary, itinerary: { date: @itinerary.date, details: @itinerary.details, location: @itinerary.location }
    assert_redirected_to itinerary_path(assigns(:itinerary))
  end
